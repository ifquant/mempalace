...
mod project_cli_bootstrap_init;
mod project_cli_bootstrap_onboarding;
mod project_cli_bootstrap_support;
mod project_cli_mining;
mod project_cli_mining_mine;
mod project_cli_mining_search;
mod project_cli_mining_support;
mod project_cli_support;
mod project_cli_transcript;
mod project_cli_transcript_normalize;
mod project_cli_transcript_split;
mod project_cli_transcript_support;
mod registry_cli;
